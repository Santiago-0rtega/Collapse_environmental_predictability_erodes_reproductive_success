---
title: "S9. Sensitivity analyses: Bloom onset thresholds"
unnumbered: true
---
...
#| label: summary-5pct
#| eval: true
summary(readRDS(here("Rdata","model_value_at_bloom_thr5.rds")))
```
...
#| label: summary-15pct
#| eval: true
summary(readRDS(here("Rdata","model_value_at_bloom_thr15.rds")))
```
...
#| label: summary-25pct
#| eval: true
summary(readRDS(here("Rdata","model_value_at_bloom_thr25.rds")))
```
:::
